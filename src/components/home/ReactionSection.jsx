  ...
  return (
    <>
      <S.HomeArticle>
        <p>관람객 반응별</p>
        <S.ReacionArticle>
          <S.PurpleBtn onClick={() => navigate("/mainposts/:genre/:location/:price_range/:date_range")}>
            <span className="material-symbols-outlined">thumb_up</span>스토리가
            흥미로워요
          </S.PurpleBtn>
          <S.BlueReBtn onClick={() => navigate("/mainposts/:genre/:location/:price_range/:date_range")}>
            <span className="material-symbols-outlined">thumb_up</span>시야
            단차가 좋아요
          </S.BlueReBtn>
          <S.GreenReBtn onClick={() => navigate("/mainposts/:genre/:location/:price_range/:date_range")}>
