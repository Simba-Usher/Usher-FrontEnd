...
export const ReactionSection = () => {
  ...
  return (
    <S.HomeArticle>
      <p>관람객 반응별</p>
      <S.ReacionArticle>
        <div onClick={() => navigate("showlist")}>
          <span className="material-symbols-outlined">thumb_up</span>스토리가
          흥미로워요
        </div>
        <div onClick={() => navigate("showlist")}>
          <span className="material-symbols-outlined">thumb_up</span>시야 단차가
          좋아요
        </div>
        <div onClick={() => navigate("showlist")}>
          <span className="material-symbols-outlined">thumb_up</span>장애인 전용
          시설
        </div>
        <div onClick={() => navigate("showlist")}>
        ...
        <div onClick={() => navigate("showlist")}>
          <span className="material-symbols-outlined">thumb_up</span>유아용·수유
          시설
        </div>
        <div onClick={() => navigate("showlist")}>
        ...
        <div onClick={() => navigate("showlist")}>
          <span className="material-symbols-outlined">thumb_up</span>노래·넘버가
          좋아요
        </div>
        <div onClick={() => navigate("showlist")}>
          <span className="material-symbols-outlined">thumb_up</span>편의 시설이
          많아요
        </div>
        <div onClick={() => navigate("showlist")}>
